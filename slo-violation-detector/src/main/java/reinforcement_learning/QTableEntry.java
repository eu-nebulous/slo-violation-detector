...
public class QTableEntry {
    ...
    public QTableEntry update(double unquantized_severity_value,double unquantized_new_severity_value, double unquantized_old_threshold_value, double unquantized_severity_threshold, double seconds_from_last_adaptation){
        int new_severity_value = (int)Math.round(unquantized_new_severity_value);
        int old_threshold = (int)Math.round(unquantized_old_threshold_value);

...
public class SeverityTests {
    ...
    public void all_metrics_Severity_test_1(){
        ...
        RealtimeMonitoringAttribute.initialize_monitoring_attribute_rates_of_change(detector,metric_names);
        ...
        RealtimeMonitoringAttribute.simple_initialize_0_100_bounded_attributes(detector,metric_names);
